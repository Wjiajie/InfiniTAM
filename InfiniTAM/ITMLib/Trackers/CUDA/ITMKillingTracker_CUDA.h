...
#include "../Interface/ITMKillingTracker.h"
#include "ITMExtendedTracker_CUDA.h"

namespace ITMLib{
class ITMKillingTracker_CUDA : public ITMKillingTracker, public ITMExtendedTracker_CUDA {
public:
	ITMKillingTracker_CUDA(const Vector2i& imgSize_d, const Vector2i& imgSize_rgb, bool useDepth, bool useColour,
