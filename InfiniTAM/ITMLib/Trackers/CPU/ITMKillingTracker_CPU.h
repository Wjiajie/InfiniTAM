...
namespace ITMLib{
class ITMKillingTracker_CPU : public ITMKillingTracker, public ITMExtendedTracker_CPU {
public:
	ITMKillingTracker_CPU(const Vector2i& imgSize_d, const Vector2i& imgSize_rgb, bool useDepth, bool useColour,
