...
namespace ITMLib{
	...
	public:
		...
		bool requiresColourRendering() const override { return true;};

		bool requiresDepthReliability() const override { return true;};

		bool requiresPointCloudRendering() const override { return true;};
	};
}//namespace ITMLib
