...
template<typename TVoxel, typename TIndex>
Vector6i ITMSceneStatisticsCalculator<TVoxel, TIndex>::ComputeVoxelBounds(const ITMVoxelVolume<TVoxel, TIndex>* scene) {
...
template<typename TVoxel, typename TIndex>
int ITMSceneStatisticsCalculator<TVoxel, TIndex>::ComputeAllocatedVoxelCount(ITMVoxelVolume<TVoxel, TIndex>* scene) {
...
template<typename TVoxel, typename TIndex>
int ITMSceneStatisticsCalculator<TVoxel, TIndex>::ComputeNonTruncatedVoxelCount(ITMVoxelVolume<TVoxel, TIndex>* scene) {
...
template<typename TVoxel, typename TIndex>
int
ITMSceneStatisticsCalculator<TVoxel, TIndex>::ComputeVoxelWithValueCount(ITMVoxelVolume<TVoxel, TIndex>* scene, float value) {
...
template<typename TVoxel, typename TIndex>
double
ITMSceneStatisticsCalculator<TVoxel, TIndex>::ComputeNonTruncatedVoxelAbsSdfSum(ITMVoxelVolume<TVoxel, TIndex>* scene) {
...
template<typename TVoxel, typename TIndex>
double ITMSceneStatisticsCalculator<TVoxel, TIndex>::ComputeTruncatedVoxelAbsSdfSum(ITMVoxelVolume<TVoxel, TIndex>* scene) {
...
template<typename TVoxel, typename TIndex>
std::vector<int> ITMSceneStatisticsCalculator<TVoxel, TIndex>::GetFilledHashBlockIds(ITMVoxelVolume<TVoxel, TIndex>* scene) {
	HashOnlyStatisticsFunctor<TVoxel,TIndex>::GetFilledHashBlockIds(scene);
	DIEWITHEXCEPTION("Not implemented");
}

template<typename TVoxel, typename TIndex>
int ITMSceneStatisticsCalculator<TVoxel, TIndex>::ComputeAllocatedHashBlockCount(ITMVoxelVolume<TVoxel, TIndex>* scene) {
...
struct MaxGradientFunctor<ITMVoxel_f_flags, TIndex> {
	static float find(ITMVoxelVolume<ITMVoxel_f_flags, TIndex>* scene, bool secondGradientField, Vector3i& maxPosition) {
...
struct MaxGradientFunctor<ITMVoxel_f_warp, TIndex> {
	static float find(ITMVoxelVolume<ITMVoxel_f_warp, TIndex>* scene, bool secondGradientField, Vector3i& maxPosition) {
		MaxGradientFunctor instance;
		instance.secondGradientField = secondGradientField;
		ITMSceneTraversalEngine<ITMVoxel,TIndex,ITMLibSettings::DEVICE_CPU>::VoxelPositionTraversal(scene, instance);
...
template<typename TVoxel, typename TIndex>
float ITMSceneStatisticsCalculator<TVoxel, TIndex>::FindMaxGradient1LengthAndPosition(ITMVoxelVolume<TVoxel, TIndex>* scene, Vector3i& positionOut) {
	return MaxGradientFunctor<TVoxel, TIndex>::find(scene, true, positionOut);
}

template<typename TVoxel, typename TIndex>
float ITMSceneStatisticsCalculator<TVoxel, TIndex>::FindMaxGradient0LengthAndPosition(ITMVoxelVolume<TVoxel, TIndex>* scene,
