 ...
 * etc.
 */
struct ITMDynamicVoxelIterationInfo {
	ITMDynamicVoxelIterationInfo(const Vector3f& warpUpdate);
public:
	Vector3f warp;
	Vector3f warpUpdate;
	...
	float voxelEnergy;
	float voxelEnergyData;
	float voxelEnergyLevelSet;
	float voxelEnergySmoothness;
	float voxelEnergyKilling;
