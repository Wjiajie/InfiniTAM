...
#include "ITMCombinedSceneLogger_InterestRegionInfo.tpp"
#include "ITMCombinedSceneLogger_SceneSlice.tpp"
...
const std::string ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::warpUpdatesFilename = "warp_updates";
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
const std::string ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::binaryFileExtension = ".dat";
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
const std::string ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::textFileExtension = ".txt";
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
const std::string ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::highlightFilterInfoFilename = "highlight_filter_info.txt";
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
const std::string ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::minRecurrenceHighlightFilterName = "min_recurrence_count_filter:";
//endregion
 ...
 */
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::ITMCombinedSceneLogger(
		std::string path,
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::SaveScenes() {
	if (!CheckDirectory()) {
		return false;
	}
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::LoadScenes() {
	if (!CheckDirectory()) {
		return false;
	}
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::SaveScenesCompact() {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::LoadScenesCompact() {
	if (!CheckDirectory()) {
		return false;
	}
	std::cout << "Loading scenes for current frame (this might take awhile)..." << std::endl;
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::StartSavingWarpState(unsigned int frameIx) {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::StopSavingWarpState() {
	warpOFStream.close();
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::SaveCurrentWarpState() {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::StartLoadingWarpState() {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::StartLoadingWarpState(unsigned int& frameIx) {
	if (this->voxelCount == -1) {
		std::cerr << "Hashed voxel count has not been obtained. Have the scenes been loaded successfully?" << std::endl;
		return false;
	}
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::StopLoadingWarpState() {
	warpIFStream.close();
 ...
 */
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::LoadCurrentWarpState() {
	if (!warpIFStream) {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::LoadPreviousWarpState() {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::IsLoadingWarpState() {
	return this->warpIFStream.is_open();
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::BufferNextWarpState() {
	if (!warpIFStream) {
		std::cout << "Attempted to read warp state with IFStream being in a bad state."
				" Was 'StartLoadingWarpState()' called?" << std::endl;
		return false;
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::BufferPreviousWarpState() {
	if (generalIterationCursor < 1) {
		return false;
	}
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::CopyWarpBuffer(float* warpDestination,
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::CopyWarpAt(int index, float voxelWarpDestination[3]) const {
	memcpy(reinterpret_cast<void*>(voxelWarpDestination), reinterpret_cast<void*>(warpBuffer + index * 2),
	       sizeof(Vector3f));
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::CopyWarpAt(int index, float* voxelWarpDestination,
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
const float* ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::WarpAt(int index) const {
	return reinterpret_cast<const float*>(warpBuffer + index * 2);
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
const float* ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::UpdateAt(int index) const {
	return reinterpret_cast<const float*>(warpBuffer + index * 2 + 1);
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
int ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::GetVoxelCount() const {
	if (voxelCount == -1) return 0;
	return voxelCount;
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::BufferCurrentWarpState(void* externalBuffer) {
	if (!warpIFStream) {
		std::cout << "Attempted to read warp state with IFStream being in a bad state."
				" Was 'StartLoadingWarpState()' called?" << std::endl;
		return false;
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::BufferPreviousWarpState(void* externalBuffer) {
	if (generalIterationCursor < 1) {
		return false;
	}
	if (warpIFStream.eof()) {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::BufferWarpStateAt(void* externalBuffer,
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::GetScenesLoaded() const {
	return voxelCount != -1;
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::LogHighlight(
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::SaveHighlights(std::string filePostfix) {
	if (!fs::is_directory(this->path)) {
		std::cout << "The directory '" << path << "' was not found.";
		return false;
	}
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::LoadHighlights(bool applyFilters, std::string filePostfix) {
	if (!fs::is_directory(this->path)) {
		std::cout << "The directory '" << path << "' was not found.";
		return false;
	}
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::SetScenes(
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::PrintHighlights() {
	std::cout << "*** Highlights ***" << std::endl;
	std::cout << this->highlights << std::endl;
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::FilterHighlights(int anomalyFrameCountMinimum) {
...
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
bool ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::CheckDirectory() {
	if (!liveScene || !canonicalScene) {
		std::cerr << "At least one of the two scenes, canonical/live, was not set to an actual scene. "
		          << __FILE__ << ":" << __LINE__ << std::endl;
	}
...
ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::GetHighlights() const {
	return ITM3DNestedMapOfArrays<ITMHighlightIterationInfo>(highlights);
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
std::string ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::GetPath() const {
	return this->path.string();
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
unsigned int ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::GetGeneralIterationCursor() const {
	return this->generalIterationCursor;
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
unsigned int ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::GetInterestIterationCursor() const {
	return this->interestIterationCursor;
}

template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::ClearHighlights() {
 ...
 */
template<typename TVoxelCanonical, typename TVoxelLive, typename TIndex>
void ITMCombinedSceneLogger<TVoxelCanonical, TVoxelLive, TIndex>::SetPath(std::string path) {
	this->path = path;
