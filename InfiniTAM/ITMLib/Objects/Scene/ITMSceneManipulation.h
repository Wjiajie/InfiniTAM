...
inline void DualVoxelPositionTraversal_DieOnMiss_CPU(ITMScene<TVoxelPrimary, TIndex>* primaryScene,
                                                     ...
                                                     ORUtils::MemoryBlock<unsigned char>* entryAllocationTypes,
                                                     TFunctor& functor) {
	DualVoxelPositionTraversal_CPU<TFunctor, DieOnMissFunctor<TVoxelSecondary,TIndex>, TVoxelPrimary, TVoxelSecondary, TIndex>(
			primaryScene, secondaryScene, entryAllocationTypes, functor, false);
};
...
void DualVoxelPositionTraversal_AllocateSecondaryOnMiss_CPU(ITMScene<TVoxelPrimary, TIndex>* primaryScene,
	...
	DualVoxelPositionTraversal_CPU<TFunctor, AllocateHashOnMissFunctor<TVoxelSecondary,TIndex>, TVoxelPrimary, TVoxelSecondary, TIndex>(
			primaryScene, secondaryScene, entryAllocationTypes, functor, reportAllocations);
};
