...
//  ================================================================
#include <iostream>
#include "ITMDynamicCameraTracker.h"

using namespace ITMLib;

ITMDynamicCameraTracker::ITMDynamicCameraTracker(const Vector2i& imgSize_d, const Vector2i& imgSize_rgb, bool useDepth,
...
void ITMLib::ITMDynamicCameraTracker::TrackCamera(ITMLib::ITMTrackingState* trackingState, const ITMLib::ITMView* view) {
