...
namespace ITMLib{
class ITMDynamicCameraTracker_CPU : public ITMDynamicCameraTracker, public ITMExtendedTracker_CPU {
public:
	ITMDynamicCameraTracker_CPU(const Vector2i& imgSize_d, const Vector2i& imgSize_rgb, bool useDepth, bool useColour,
