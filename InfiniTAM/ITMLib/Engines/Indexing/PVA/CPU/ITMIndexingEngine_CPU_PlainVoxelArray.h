...
class ITMIndexingEngine<TVoxel, ITMPlainVoxelArray, MEMORYDEVICE_CPU> :
		public ITMIndexingEngineInterface<TVoxel, ITMPlainVoxelArray>{
private:
...
public:
	...
	void AllocateUsingOtherVolume(ITMVoxelVolume<TVoxelATarget, ITMPlainVoxelArray>* targetVolume,
