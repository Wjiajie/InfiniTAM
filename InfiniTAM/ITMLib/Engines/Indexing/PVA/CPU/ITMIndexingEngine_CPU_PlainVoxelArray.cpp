...
#include "ITMIndexingEngine_CPU_PlainVoxelArray.tpp"
...
template void ITMIndexingEngine<ITMVoxel, MEMORYDEVICE_CPU,
		ITMIndexingEngine<ITMVoxel, ITMPlainVoxelArray, MEMORYDEVICE_CPU>::
