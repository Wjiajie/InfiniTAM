...
#define ITM_SERIALIZATION_IMPL_UNPACK(M, C, x)                                                                         \
  ITM_SERIALIZATION_IMPL_FUNC_EXPAND(M, C, ITM_SERIALIZATION_IMPL_SIMPLE_PASTE x)
#else
#define ITM_SERIALIZATION_IMPL_UNPACK(M, C, x)                                                                         \
