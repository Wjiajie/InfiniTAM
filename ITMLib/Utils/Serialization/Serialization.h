 ...
 */
#ifdef _MSC_VER
#define GENERATE_SERIALIZABLE_STRUCT(struct_name, ...) SERIALIZABLE_STRUCT_IMPL(struct_name, __VA_ARGS__)
#define GENERATE_PATHLESS_SERIALIZABLE_STRUCT(struct_name, ...) PATHLESS_SERIALIZABLE_STRUCT_IMPL(struct_name, __VA_ARGS__)
#define DECLARE_SERIALIZABLE_STRUCT(struct_name, ...) SERIALIZABLE_STRUCT_DECL_IMPL(struct_name, __VA_ARGS__)
#define DEFINE_SERIALIZABLE_STRUCT(struct_name, ...) SERIALIZABLE_STRUCT_DEFN_IMPL(struct_name, __VA_ARGS__)
#define DEFINE_INNER_SERIALIZABLE_STRUCT(struct_name, ...) SERIALIZABLE_STRUCT_DEFN_IMPL(struct_name, __VA_ARGS__)

#define GENERATE_SERIALIZABLE_ENUM(enum_name, ...) SERIALIZABLE_ENUM_IMPL(enum_name, __VA_ARGS__)
#define DECLARE_SERIALIZABLE_ENUM(enum_name, ...) SERIALIZABLE_ENUM_DECL_IMPL(enum_name, __VA_ARGS__)
#define DEFINE_SERIALIZABLE_ENUM(enum_name, ...) SERIALIZABLE_ENUM_DEFN_IMPL(, enum_name, __VA_ARGS__)
#define DEFINE_INLINE_SERIALIZABLE_ENUM(enum_name, ...) SERIALIZABLE_ENUM_DEFN_IMPL(inline, enum_name, __VA_ARGS__)
#else
