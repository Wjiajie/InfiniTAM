...
bool SegmentIntersectsGridAlignedBox3D(ITMSegment segment, Vector3f boxMin, Vector3f boxMax){
 ...
 */
_CPU_AND_GPU_CODE_ inline
bool SegmentIntersectsGridAlignedCube3D(ITMSegment segment, Vector3f cubeMin, float cubeSideLength){
