...
#include "../Interface/ITMDynamicCameraTracker.h"
#include "ITMExtendedTracker_CUDA.h"

namespace ITMLib{
class ITMDynamicCameraTracker_CUDA : public ITMDynamicCameraTracker, public ITMExtendedTracker_CUDA {
public:
	ITMDynamicCameraTracker_CUDA(const Vector2i& imgSize_d, const Vector2i& imgSize_rgb, bool useDepth, bool useColour,
