...
namespace ITMLib{
	class ITMDynamicCameraTracker : public virtual ITMExtendedTracker  {

	public:

		ITMDynamicCameraTracker(const Vector2i& imgSize_d, const Vector2i& imgSize_rgb, bool useDepth, bool useColour,
