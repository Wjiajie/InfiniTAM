...
if (${CMAKE_VERSION} VERSION_LESS 3.8 OR (MSVC_IDE AND ${CMAKE_VERSION} VERSION_LESS 3.9))
    ...
    add_library(${targetname} STATIC ${sources} ${headers} ${templates} ../ITMLib/Objects/Scene/ITMVoxelBlockHash.cpp ../ITMLib/SurfaceTrackers/Interface/SlavchevaSurfaceTracker.cpp)
