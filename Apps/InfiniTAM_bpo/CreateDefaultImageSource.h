...
/** Create a default source of depth images from a list of command line
    ...
    be tried.
*/
void CreateDefaultImageSource(ImageSourceEngine*& imageSource, IMUSourceEngine*& imuSource, const ITMLib::Configuration::InputAndOutputSettings_Paths& inputPaths);
